...
import { Users, Mail, Phone, MapPin, Calendar, FileText, BadgeCheck, GraduationCap, Building, Globe, Landmark, ArrowLeft, Edit2, ShieldCheck, UserCircle } from 'lucide-react';
            ...
            header={
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 leading-tight">Student Profile</h2>
                            <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest text-left">Detailed academic record</p>
                        </div>
                    </div>
                    <Link
                        ...
                        <div className="px-10 pb-10 -mt-16">
                            <div className="flex flex-col md:flex-row items-end gap-6 text-left">
                                ...
                                <div className="flex-1 pb-2 text-left">
                                    <h1 className="text-4xl font-black text-gray-900 mb-1">{student.first_name} {student.last_name}</h1>
                                    <div className="flex flex-wrap gap-4 items-center text-gray-400 font-bold text-xs uppercase tracking-widest">
                                        ...
                                        <span className="flex items-center gap-2">
                                            ...
                                            {student.classes?.[0]?.name || 'Unassigned Class'}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
                                    <InfoItem icon={<UserCircle />} label="Full Name" value={`${student.first_name} ${student.last_name}`} />
                                    <InfoItem icon={<Mail />} label="Email Address" value={student.user?.email} />
                                    <InfoItem icon={<FileText />} label="CNIC / ID Card" value={student.cnic || 'Not Provided'} />
                                    <InfoItem icon={<BadgeCheck />} label="Admission #" value={student.admission_number} />
                                    <InfoItem icon={<Calendar />} label="Admission Date" value={student.admission_date || 'N/A'} />
                                    <InfoItem icon={<GraduationCap />} label="Category" value={student.gender || 'Not Specified'} />
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12 text-left">
                                    <InfoItem icon={<Phone />} label="Phone Number" value={student.phone || 'N/A'} />
                                    <InfoItem icon={<Calendar />} label="Date of Birth" value={student.date_of_birth || 'N/A'} />
                                    <div className="md:col-span-2">
                                        <InfoItem icon={<Landmark />} label="Full Address" value={student.address || 'N/A'} />
                                    </div>
                                    <InfoItem icon={<Building />} label="City" value={student.city || 'N/A'} />
                                    <InfoItem icon={<Globe />} label="State & Country" value={`${student.state || 'N/A'}, ${student.country || 'N/A'}`} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="bg-gradient-to-br from-blue-600 to-indigo-800 rounded-[2rem] p-8 text-white shadow-xl shadow-blue-100">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-[10px] font-black uppercase tracking-widest opacity-40 leading-relaxed">Account created on {new Date(student.created_at).toLocaleDateString()}</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-8">
                                ...
                                <div className="space-y-3">
                                    <Link href={route('students.index')} className="w-full flex items-center gap-3 p-4 bg-gray-50 rounded-2xl text-gray-600 font-bold text-xs hover:bg-gray-100 transition">
...
// Helper to inject React if needed by InfoItem (though normally it's global or handled by bundler in Next/Vite)
