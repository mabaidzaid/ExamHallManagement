...
export default function ClassesCreate({ teachers }) {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800 leading-tight">Define New Class</h2>
                        <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">Create a new academic intake</p>
                    </div>
                </div>
            }
        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end p-4">
                            ...
                            >
                                ...
                                {processing ? 'Defining Class...' : 'Define Class Now'}
                            </button>
                        </div>
                    </form>
                </div>
