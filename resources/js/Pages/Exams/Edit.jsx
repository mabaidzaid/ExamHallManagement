...
import { CalendarCheck, Save, X, Type, Search, Clock, CalendarDays, BookOpen, Presentation, Info, CheckCircle2 } from 'lucide-react';

export default function ExamsEdit({ exam, subjects, classes }) {
            ...
            header={
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 leading-tight">Edit Active Exam</h2>
                            <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">Update scheduling config for {exam.title}</p>
                        </div>
                    </div>
                    <Link
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="bg-white rounded-[2.5rem] shadow-xl shadow-gray-100 border border-gray-100 overflow-hidden">
                            ...
                            <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="group">
                                    <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">Current Status</label>
                                    <div className="flex items-center bg-gray-50 rounded-2xl border-2 border-transparent focus-within:border-blue-500/10 focus-within:bg-white transition-all h-[56px] group">
                                        <div className="pl-4 pr-2 text-gray-400 group-focus-within:text-blue-500 transition-colors">
                                        ...
                                        >
                                            ...
                                            <option value="postponed">Postponed / Delayed</option>
                                        </select>
                                    </div>
                                </div>
