...
export default function Edit({ role, permissions, selectedPermissions, auth }) {
    ...
    const handlePermissionChange = (permissionId) => {
        const newPermissions = checkedPermissions.includes(permissionId)
    ...
    const isSystemRole = ['admin', 'super-admin', 'user'].includes(role.name);
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Update role details and permissions</p>
                    </div>

                    {/* System Role Warning */}
                    {isSystemRole && (
                        <div className="mb-6 p-4 bg-yellow-100 border border-yellow-400 text-yellow-800 rounded-lg">
                            <p className="font-semibold">⚠️ System Role</p>
                            <p className="text-sm mt-1">This is a system role. Modifications should be done with caution.</p>
                        </div>
                    )}
