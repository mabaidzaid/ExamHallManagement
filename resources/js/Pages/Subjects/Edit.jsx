        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-2xl font-bold text-gray-800 leading-tight">Edit Subject</h2>
                        <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">Update details for {subject.name}</p>
                    </div>
                </div>
            }
        >
