...
import { Building2, Save, X, Hash, Users, MapPin, Layers } from 'lucide-react';

export default function RoomsEdit({ room, roomTypes }) {
            ...
            header={
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-gray-800 leading-tight">Edit Physical Room</h2>
                            <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">Updating details for {room.name}</p>
                        </div>
                    </div>
                    <Link
